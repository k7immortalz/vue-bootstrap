$('#collapseMap').on('shown.bs.collapse', function(e){
	...
	if (!Array.prototype.forEach)
		...
		markersData = {
			'Marker': [
			{
				type_point: 'Koramangala',
				name: 'Park Hyatt Paris',
				location_latitude: 48.865633, 
				location_longitude: 2.321236,
				map_image_url: 'img/thumb_map_single_vasite.jpg',
				rate: 'Superb | 7.5',
				name_point: 'Park Hyatt Paris',
				get_directions_start_address: '',
				phone: '+3934245255',
				url_point: 'vasite-detail.html'
			},
			{
				type_point: 'Koramangala',
				name: 'vasite Mariott',
			...
			{
				type_point: 'Koramangala',
				name: 'vasite Place Concorde',
				location_latitude: 48.860642,
				location_longitude: 2.352245,
				map_image_url: 'img/thumb_map_single_vasite.jpg',
				rate: 'Superb | 7.5',
				name_point: 'vasite Place Concorde',
				get_directions_start_address: '',
				phone: '+3934245255',
				url_point: 'vasite-detail.html'
			},

      ...
      <nav class="secondary_nav sticky_horizontal">
        <div class="container">
          <ul class="clearfix">
            ...
            <li><a href="#buy">Buy (4)</a></li>
            <li><a href="#rent">Rent (2)</a></li>
            <li><a href="#plans">Plans</a></li>
            <li><a href="#location">Location</a></li>
            <li><a href="#sidebar">Request</a></li>
          </ul>
        </div>
      </nav>
            ...
            <section id="overview">
                ...
                <ul class="cbp_tmtimeline">
                  <li>
                    <div class="cbp_tmlabel">
                      ...
                      <div class="row">
                        <div class="col-lg-4">
                          <p>Carper Area<br />2062 Sq.ft</p>
                        </div>
                        <div class="col-lg-4">
                          <p>Possesion On<br />Dec'21</p>
                        </div>
                        <div class="col-lg-4">
                          <p>Amenties<br />Parking</p>
                        </div>
                      </div>
                    </div>
                  </li>
              ...
              <section id="unit">
                ...
                <table class="table">
                  ...
                  <tbody>
                    <tr>
                      <td>2 BHK Apartment Availability*: Sold out</td>
                      <td>1350 - 1400 sq.ft (125.42 - 130.06 sq.m)</td>
                      <td>NA</td>
                      <td>78.97 L - 81.90 L</td>
                      <td>NA</td>
                      <td>NA</td>
                    </tr>
                    <tr>
              ...
              <section id="location">
                ...
                <div id="map" class="map map_single add_bottom_30">
                  ...
                  ></div>
                  <h4>Address</h4>
                  <p>Sarjapur Attibele Road, Bangalore, Karnataka, INDIA.</p>
                </div>

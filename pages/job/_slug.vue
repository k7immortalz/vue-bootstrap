<template>
  <main>
    <section class="hero_in prjcts_detail">
      <div class="wrapper">
        <div class="container">
          <h1 class="fadeInUp"><span></span>{{ job.title }}</h1>
        </div>
      </div>
    </section>
    <!--/hero_in-->
  ...
  <center>
   <b-button id="show-btn" variant="success" @click="$bvModal.show('bv-modal-career')">Apply</b-button>
  ...
  <b-modal id="bv-modal-career" class="mt-10" size="lg" centered scrollable hide-footer>  
    <div class="d-block text-center">
       <CareersForm :item="job" />
    </div>
  </b-modal>
